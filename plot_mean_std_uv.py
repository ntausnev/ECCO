...
from  mean_std_uv import mean_std_uv
...
# PLOT_ONLY_G = False  # comment out if you need ocean H plot
  ...
  title_3 =  "Wind Jul2009-Apr2010 10 Month Average Curve"

  if PLOT_ONLY_G:
#   file_out_pdf = DATA_OUT + "E2.1-G Wind Jul2009-Apr2020 10 Month Average Curve With StdDev" + ".pdf"
    file_out_pdf = DATA_OUT + "E2.1-G Wind Jul2009-Apr2010 10 Month Average Curve" + ".pdf"
    legend_dstg = "E2.1-G"
    legend_dsth = ""
    title_1 = "E2.1-G"
  if PLOT_ONLY_H:
#   file_out_pdf = DATA_OUT + "E2.1-H Wind Jul2009-Apr2020 10 Month Average Curve With StdDev" + ".pdf"
    file_out_pdf = DATA_OUT + "E2.1-H Wind Jul2009-Apr2010 10 Month Average Curve" + ".pdf"
    legend_dstg = ""
    legend_dsth = "E2.1-H"
    title_1 = "E2.1-H"
  ...
  y_zero = np.zeros(x_plot.size)

  avr_avr_ug = np.nanmean(ug_mean)
  print("avr_avr_ug:")
  print(avr_avr_ug)
  avr_avr_uh = np.nanmean(uh_mean)
  avr_avr_vg = np.nanmean(vg_mean)
  avr_avr_vh = np.nanmean(vh_mean)
...
#   list_avrs_uh.append(wmean_h)
  ...
  # Set title for the plot
    if month_total == 1:
      ax1.set_title(
#         "E2.1-H U Wind Jul2009-Apr2010 10 Month Average Curve",
          title_1 + " U " + title_3,
          pad=25,
          fontweight="bold")
...
#   ax1.errorbar(x_plot, uh_mean, yerr=uh_std*0.5,          color="green")
...
#   list_avrs_vh.append(wmean_h)
    ...
    if month_total == 1:
      ax2.set_title(
#         'E2.1 V Wind 10m Height Along Equator 2°x2° Monthly-Mean Jul2009-Apr2020',
#         "E2.1-H Wind Jul2009-Apr2010 10 Month Average Curve",
#         "E2.1 V Wind Jul2009-Apr2020 10 Month Average Curve With StdDev",
#         "E2.1-H V Wind 10m Height Along Equator 2°x2° Jul2009-Apr2010 10 Month Average Curve",
#         "E2.1-H V Wind Jul2009-Apr2010 10 Month Average Curve",
          title_1 + " V " + title_3,
          pad=25,
          fontweight="bold")
    ax2.set_ylim(-6., 8.)
    ...
    generate_plot(ax2, plt, x_plot, y_ocng, y_ocnh, y_zero, line_g, line_h,
                  legend_dstg, legend_dsth, y_ticks)
#   ax2.errorbar(x_plot, vh_mean, yerr=vh_std*0.5,          color="green")
...
#     plt.savefig(file_out_pdf)
  ...
  print("\navr_avr_ug = {:.2f}, avr_avr_uh = {:.2f}".format(
      avr_avr_ug, avr_avr_uh))
  print("\navr_avr_vg = {:.2f}, avr_avr_vh = {:.2f}".format(
      avr_avr_vg, avr_avr_vh))
